...
.run(function(AuthService, $rootScope, $state, $http, AuthService) {
    ...
    tokenAndUser = angular.fromJson(localStorage.getItem('tokenAndUser'));
    if(tokenAndUser != null){
        $http.defaults.headers.common['Authorization'] = 'Bearer ' + tokenAndUser.token;
        AuthService.user = tokenAndUser.user;
    }
